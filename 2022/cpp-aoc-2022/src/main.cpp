...
//    std::cout << std::endl;
    ...
    std::cout << "Day 06 part 1: ";
    std::cout << day06_part1(read_input_file("day06.txt")[0]) << std::endl;
    std::cout << "Day 06 part 2: ";
    std::cout << day06_part2(read_input_file("day06.txt")[0]) << std::endl;
    std::cout << std::endl;
